...
class Feeder(Dataset):
    ...
    def load_data(self):
        ...
        if self.split == 'train':
          self.data = np.load(self.data_path + '/train_joint.npy')  # 加载训练数据
          self.label = np.load(self.data_path + '/train_label.npy')  # 加载训练标签
          self.sample_name = ['train_' + str(i) for i in range(len(self.data))]
        elif self.split == 'test':
          # self.data = np.load(self.data_path + '/test_A_joint.npy')  # 加载测试数据
          # self.label = np.load(self.data_path + '/test_A_label.npy')  # 加载测试标签
          self.data = np.load(self.data_path + '/test_joint_bone.npy')  # 加载测试数据
        ...
        # print('66666666666666666666666666666666666666666666666666666666666666666666666666666666666666666666666666666666666')
